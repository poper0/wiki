*Current status:* The WiFi dongle is not cooperating.  The mobile unit has a bad XLR input. Otherwise the Zephyrs are in working order and we are capable of remote broadcast.
